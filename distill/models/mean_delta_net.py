...
class MeanDeltaNet(nn.Module):
    r"""
    Mean-DeltaNet variant with update:
    ...
    def __init__(
        ...
        norm_eps: float = 1e-5,
        mean_recompute_chunk_size: int = 128,
        **kwargs,
    ) -> MeanDeltaNet:
        super().__init__()
        ...
        if mode == "chunk":
            warnings.warn(
                "MeanDeltaNet currently implements only fused recurrent operator; "
        ...
        self.mean_recompute_chunk_size = int(mean_recompute_chunk_size)
    ...
    def forward(
        ...
        **kwargs: Unpack[dict],
        ...
        o, recurrent_state = fused_recurrent_mean_delta_rule(
            q=q,
            k=k,
            v=v,
            ...
            recompute_chunk_size=self.mean_recompute_chunk_size,
        )
